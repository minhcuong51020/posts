...
public class EmailRepositoryCustom {
    ...
    public List<EmailEntity> search(EmailSearchRequest request, String currentUserId) {
        Map<String, Object> values = new HashMap<>();
        StringBuilder sql = new StringBuilder("SELECT R FROM EmailEntity R ");
        sql.append(createWhereQuery(request, currentUserId, values));
        sql.append(createOrderQuery(request.getSortBy()));
        Query query = entityManager.createQuery(sql.toString(), EmailEntity.class);
    ...
    public Long count(EmailSearchRequest request, String currentUserId) {
        Map<String, Object> values = new HashMap<>();
        StringBuilder sql = new StringBuilder("SELECT COUNT(R) FROM EmailEntity R ");
        sql.append(createWhereQuery(request, currentUserId, values));
    ...
    private String createWhereQuery(EmailSearchRequest request, String currentUserId, Map<String, Object> values) {
        StringBuilder sql = new StringBuilder(" ");
